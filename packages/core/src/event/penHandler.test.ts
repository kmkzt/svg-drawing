...
describe('PenHandler', () => {
  ...
  describe('cleanup', () => {
    ...
    it('Remove mouseEvent listener when SUPPORT_POINTER_EVENT is false and SUPPORT_TOUCH_ON_START', () => {
      const el = document.createElement('div')
    ...
    it('Remove pointerEvent listener when SUPPORT_POINTER_EVENT is true', () => {
      const el = document.createElement('div')
    ...
    it('Remove touchEvent listener when SUPPORT_TOUCH_ON_START is true and SUPPORT_POINTER_EVENT is false.', () => {
      const el = document.createElement('div')
